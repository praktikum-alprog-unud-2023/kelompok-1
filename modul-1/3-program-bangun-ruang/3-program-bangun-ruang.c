...
double limasSegiempatVolume(double, double);
double limasSegiempatLuasPermukaan(double, double);
double prismaSegitigaVolume(double, double);
double prismaSegitigaLuasPermukaan(double, double, double);
...
void menuLimasSegiempat()
{
  double luasalas, tinggi, luassisitegak;
  head();
  outLine();
  ...
  head();
  outMsg("Masukan Luas sisi tegak = ");
  outLine();
  inputThisDouble("luas sisi tegak = ", &luassisitegak);
  outMsg("Masukkan tinggi limas");
  outLine();
  inputThisDouble("tinggi limas = ", &tinggi);
  head();
  outMsg("luas alas = %lf", luasalas);
  outMsg("tinggi limas = %lf", tinggi);
  outMsg("luas sisi tegak = %1f", luassisitegak);
  outLine();
  outMsg("hasil perhitungan");
  outMsg("volume = %lf", limasSegiempatVolume(luasalas / 3, tinggi));
  outMsg("luas permukaan = %lf", limasSegiempatLuasPermukaan(luasalas / 3, luassisitegak));
  outLine();
  endMsg();
}
void menuPrismaSegitiga()
{
  double luasalas, tinggi, kelilingalas;
  head();
  outLine();
  ...
  inputThisDouble("luas alas = ", &luasalas);
  head();
  outMsg("Masukan Keliling alas = ");
  outLine();
  inputThisDouble("Keliling alas = ", &kelilingalas);
  outMsg("Masukkan tinggi Prisma");
  outLine();
  inputThisDouble("tinggi = ", &tinggi);
  head();
  outMsg("luas alas = %lf", luasalas);
  outMsg("tinggi prisma = %lf", tinggi);
  outMsg("Keliling alas = %1f", kelilingalas);
  outLine();
  outMsg("hasil perhitungan");
  outMsg("volume = %lf", prismaSegitigaVolume(luasalas / 3, tinggi));
  outMsg("luas permukaan = %lf", prismaSegitigaLuasPermukaan(luasalas / 3, kelilingalas, tinggi));
  outLine();
  endMsg();
}
void menuKerucut()
...
double limasSegiempatLuasPermukaan(double luasalas, double luassisitegak)
{
...
double prismaSegitigaLuasPermukaan(double luasalas, double kelilingalas, double tinggi)
{
